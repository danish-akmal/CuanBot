...
INDODAX_API_KEY = os.environ.get('Z26WYKEZ-9PY0LWBJ-X6GPWUQW-YJVMYXOJ-3IESCMQY')
INDODAX_API_SECRET = os.environ.get('f114d5172ca682bf8517ea0264cb6795788f46db2da625e69f00ffbcdc64f7683baf8d2c83f1b0a7')
COINMARKETCAL_API_KEY = os.environ.get('COINMARKETCAL_API_KEY')

# --- PENGATURAN TELEGRAM (DIBACA DARI ENVIRONMENT VARIABLES) ---
TELEGRAM_TOKEN = os.environ.get('7953844765:AAEVxReMkeMh7E86F6ip5kEgZ_YafzRLYEs')
TELEGRAM_CHAT_ID = os.environ.get('7459916311')
